...
We are discussing the creation of a benchmark to compare facilities and storage systems. This challenge is explored on our task page: \url{https://www.vi4io.org/std/io500} and mailing list. 
...
\begin{itemize}\compresslist
\item Support standardization efforts
  \begin{itemize}\compresslist
...
\item IO-500 agenda:
  \begin{itemize}
  \item June'17, proposal for benchmark
  \item Benchmark runs on Top-500 sites
  \item Nov'17, SC -- presentation of results
  \end{itemize}
\item Extending benchmarks, HPSL sites
