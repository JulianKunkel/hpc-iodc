...
We started a discussion about creation of an I/O benchmark that allows comparison of facilities and storage systems. This challenge is approached on our mailing list: io-500.
...
\begin{itemize}
\item Applications with well optimized I/O patterns
\item Applications that require a random-like workload
\item Usage that depends on metadata and small files / objects
\end{itemize}
\end{itemize}
\end{minipage}
\qquad
